...
const PROJECTS: ProjectData[] = [
    {
        ...
        category: 'Personal',
        name: 'TravelMate',
        liveUrl: 'https://travellmate.vercel.app/',
        col1Image1: '/Travelmate.png',
        col1Image2: '/Travelmate2.png',
        col2Image: '/Travelmate3.png',
      },
      {
        number: '02',
        category: 'Personal · Cafe',
        name: 'Caferia',
        liveUrl: 'https://caferiavintagecafe.vercel.app/',
        col1Image1: '/Caferia.png',
        col1Image2: '/Caferia2.png',
        col2Image: '/Caferia3.png',
      },
      {
       number: '03',
       category: 'Personal',
       name: 'SpotifyClone',
       liveUrl: 'https://spotifycl0ne.vercel.app',
       col1Image1: '/Spotify.png',
       col1Image2: '/Spotify2.png',
       col2Image: '/Spotify3.png',
      },
      {
       number: '04',
       category: 'Personal',
