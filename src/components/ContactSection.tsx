...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rohitgurjar1183@gmail.com',
    href: 'mailto:rohitgurjar1183@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    ...
    href: 'https://wa.me/919301914793',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/rohitgurjar12',
    href: 'https://www.linkedin.com/in/rohitgurjar12/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@rohitgurjar12',
    href: 'https://github.com/rohitgurjar12',
  },
];
